...
The objective of this project is to design, calibrate, and preliminarily evaluate a low-cost automatic irrigation controller that uses soil-moisture feedback to identify dry conditions and automatically activate a water pump when the soil becomes dry.

## Hypothesis

Based on preliminary sensor observations, I hypothesized that a calibrated ADC threshold could distinguish dry soil from adequately moist soil and trigger irrigation when necessary. Readings below 100 were treated separately as a possible sensor fault.
...
- **Motor driver module:** Controls the water pump through GPIO18 (INA) and GPIO19 (INB).
<p align="center">
  <img src="required_components.png" alt="Final system components" width="45%">
  &nbsp;
  <img src="wiring_diagram_english.png" alt="Final system wiring diagram" width="45%">
</p>
